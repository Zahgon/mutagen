...
func (x SynchronizationMode) Enum() *SynchronizationMode { _ = "STUB: not implemented"; return nil }

func (x SynchronizationMode) String() string { _ = "STUB: not implemented"; return "" }
...
func file_synchronization_core_mode_proto_init() { _ = "STUB: not implemented"; return }
